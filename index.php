...
<?php
#/ گشتی مافەکان پارێزراون ®️ /
ob_start();
MEDOO01 = "8916246734:AAEkks4zyD4l5qMPIY1TCqVOKgTcTA2c_W0";
define('API_KEY',$MEDOO01);
echo file_get_contents("[https://api.telegram.org/bot$MEDOO01/setwebhook?url=](https://api.telegram.org/bot$MEDOO01/setwebhook?url=)".$_SERVER['SERVER_NAME'].""._SERVER['SCRIPT_NAME']);
